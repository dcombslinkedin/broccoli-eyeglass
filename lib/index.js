...
module.exports = class EyeglassCompiler extends BroccoliSassCompiler {
  constructor(inputTrees, options) {
    ...
    console.log("##### CREATING EYEGLASSCOMPILER INSTANCE");
  ...
  handleNewFile(details) {
    let h = heimdall.start("EyeglassCompiler:handleNewFile");
  ...
  cachableOptions(rawOptions) {
    let h = heimdall.start("EyeglassCompiler:cachableOptions");
  ...
  dependenciesHash(srcDir, relativeFilename, options) {
    let h = heimdall.start("EyeglassCompiler:dependenciesHash");
  ...
  keyForSourceFile(srcDir, relativeFilename, options) {
    let h = heimdall.start("EyeglassCompiler:keyForSourceFile");
  ...
  cacheAssetImports(key, getValue) {
    let h = heimdall.start("EyeglassCompiler:cacheAssetImports");
